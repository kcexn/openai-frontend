<div class="layout-container flex h-full grow flex-col">
    ...
    >
        <div class="flex items-center gap-4 text-[#0d141c]">
            ...
            <h2 class="text-[#0d141c] text-lg font-bold leading-tight tracking-[-0.015em]">Chatbot</h2>
        </div>
        <div class="flex flex-1 justify-end gap-8">
            ...
            <div
                ...
                style="background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuCJF5taGpwASORuHFpMAgDCuUVrF6BZwBIotRnHeLVwYO1ad2p30CJ1MG8znkZAY0Piqo2aYm-O8qygNouQcVNnAhj8jCJrb3LxGp07x9MaPdjx7ZG7mG7142XYbfh8WIHg5G43UAmBb9jmu9KslNQw8CUuhvjLpJQJAYBVEGCp8O9HaZHzRSaly6OGm0Ibmzsy7IxDeY7cCw4idxIPs-tVctbpOryZD0AoNwWp8Z-Gkm1ncg6jAmpL14yiPgrYYbcD78NE6uhdLdP3");"
            ></div>
        </div>
    </header>
    <div class="px-40 flex flex-1 justify-center py-5">
        ...
        >
            <div class="flex flex-wrap justify-between gap-3 p-4">
                <p class="text-[#0d141c] tracking-light text-[32px] font-bold leading-tight min-w-72">
                    Settings
                </p>
            </div>
            <h3
                class="text-[#0d141c] text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4"
            >
                Chatbot
            </h3>
            <div class="flex items-center gap-4 bg-slate-50 px-4 min-h-[72px] py-2 justify-between">
                ...
                <div class="shrink-0">
                    <p class="text-[#0d141c] text-base font-normal leading-normal">Creative</p>
                </div>
            </div>
            <div class="flex items-center gap-4 bg-slate-50 px-4 min-h-[72px] py-2 justify-between">
                <div class="flex flex-col justify-center">
                ...
                <div class="shrink-0">
                    <div
                        class="text-[#0d141c] flex size-7 items-center justify-center"
